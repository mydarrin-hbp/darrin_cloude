 ...
 *   cost_curier:number, cost_asigurare:number, cost_transport_greutate:number, cost_ajutor:number, subtotal:number,
...
async function calculeazaPret(input = {}) {
  ...
  const subtotal = cost_baza_servicii + cost_materiale + cost_chirie_scule + cost_curier + cost_asigurare + cost_transport_greutate + cost_ajutor;
  ...
  return {
    cost_baza_servicii, cost_materiale, cost_chirie_scule, cost_curier, cost_asigurare, cost_transport_greutate, cost_ajutor,
...
module.exports = { calculeazaPret, citestePragMinimComanda };
