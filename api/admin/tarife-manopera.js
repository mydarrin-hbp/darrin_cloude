  ...
  if (req.method === 'POST') {
    ...
    if (action === 'salveaza') {
      ...
      const rand = {
        ...
        cost_ora,
        cost_deplasare: cost_deplasare ?? null,
        cost_uzura_scule: cost_uzura_scule ?? null,
        cost_consumabile_mici: cost_consumabile_mici ?? null,
        cost_echipament_testare: cost_echipament_testare ?? null,
